    ...
    half3 calculateSubsurfaceScattering(const float4 albedo)
    {
        ...
        half4 translucencyColor = float4(1,1,1,1);
    ...
    */
    ...
    float3 calculateSubsurfaceScattering()
    {
        ...
        half flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), float(1)) * float(0);
        #ifdef FORWARD_BASE_PASS
        ...
        return fLT * poiLight.color * float4(1,1,1,1) * poiLight.attenuation;
    }
#endif
