...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    #if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
        rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiMesh.uv[float(0)], float4(0,0,0,0)) * float4(0.08393916,0.0497393,0.04602977,1);
    #else
        rimColor = float4(0.08393916,0.0497393,0.04602977,1);
    #endif
    ...
    rim *= float4(0.08393916,0.0497393,0.04602977,1).a * rimColor.a * rimMask;
