Shader "Hidden/.poiyomi/• Poiyomi Toon •/Stocking 2-Stocking 2"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi Toon V7.2.42</color>", Float) = 0
...
#define PROP_DETAILBRIGHTNESS 0.8
...
#define PROP_RIMWIDTH 0.948
#define PROP_RIMSHARPNESS 0.078
#define PROP_RIMSTRENGTH 0
#define PROP_RIMBRIGHTEN 0.67
...
#define PROPM_START_RIMWIDTHNOISE 1
#define PROP_RIMWIDTHNOISETEXTUREUV 0
#define PROP_RIMWIDTHNOISESTRENGTH 0.858
#define PROPM_END_RIMWIDTHNOISE 0
#define PROPM_START_SHADOWMIX 1
#define PROP_SHADOWMIX 0.097
#define PROP_SHADOWMIXTHRESHOLD 0.144
#define PROP_SHADOWMIXWIDTHMOD 10
...
#define PROP_MATCAPINTENSITY 1.5
#define PROP_MATCAPLIGHTMASK 0
#define PROP_MATCAPREPLACE 0.029
#define PROP_MATCAPMULTIPLY 0.601
...
#define PROP_SPECULARSMOOTHNESS -0.54
...
#define PROP_GLITTERJITTER 0
#define PROP_GLITTERSPEED 10
#define PROP_GLITTERSIZE 0.116
#define PROP_GLITTERCONTRAST 948
#define PROP_GLITTERANGLERANGE 0
#define PROP_GLITTERMINBRIGHTNESS 0
#define PROP_GLITTERBRIGHTNESS 0.2
#define PROP_GLITTERBIAS 0.686
