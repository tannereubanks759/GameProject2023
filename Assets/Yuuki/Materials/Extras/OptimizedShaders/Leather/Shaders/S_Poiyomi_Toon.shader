Shader "Hidden/.poiyomi/• Poiyomi Toon •/Leather-Leather"
{
    Properties
    {
...
#define PROP_SHADOWSTRENGTH 0.08
...
#define PROP_RIMWIDTH 0.6
#define PROP_RIMSHARPNESS 0.1
#define PROP_RIMSTRENGTH 0
#define PROP_RIMBRIGHTEN 0.66
#define PROP_RIMLIGHTCOLORBIAS 0.053
...
#define PROP_GLITTERFREQUENCY 10000
#define PROP_GLITTERJITTER 1
#define PROP_GLITTERSPEED 10
#define PROP_GLITTERSIZE 1
#define PROP_GLITTERCONTRAST 400
#define PROP_GLITTERANGLERANGE 3
#define PROP_GLITTERMINBRIGHTNESS 0
#define PROP_GLITTERBRIGHTNESS 0.9
#define PROP_GLITTERBIAS 0.1
