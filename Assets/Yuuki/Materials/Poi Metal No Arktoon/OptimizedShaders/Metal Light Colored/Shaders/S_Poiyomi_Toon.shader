Shader "Hidden/.poiyomi/• Poiyomi Toon •/Metal Light Colored-Metal Light Colored"
{
    Properties
    {
...
#define PROP_CLEARCOAT 0.824
#define PROP_CLEARCOATGLOSSINESS 1
#define PROP_CLEARCOATANISOTROPY 0
#define PROP_CLEARCOATENABLEREFLECTIONS 1
#define PROP_CLEARCOATENABLESPECULAR 1
#define PROP_CLEARCOATFALLBACK
#define PROP_CLEARCOATFORCEFALLBACK 1
...
#define PROP_MATCAPINTENSITY 3.58
