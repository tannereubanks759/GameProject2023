Shader "Hidden/.poiyomi/• Poiyomi Toon •/Blonde Hair 1-Blonde Hair 1"
{
    Properties
    {
...
#define PROP_MATCAPEMISSIONSTRENGTH 0.77
#define PROP_MATCAPINTENSITY 0.36
#define PROP_MATCAPLIGHTMASK 0
#define PROP_MATCAPREPLACE 0
#define PROP_MATCAPMULTIPLY 0.173
#define PROP_MATCAPADD 0.237
...
#define PROP_GLITTERSPEED 5
#define PROP_GLITTERSIZE 0.037
#define PROP_GLITTERCONTRAST 300
#define PROP_GLITTERANGLERANGE 0
#define PROP_GLITTERMINBRIGHTNESS 0.314
#define PROP_GLITTERBRIGHTNESS 26.4
#define PROP_GLITTERBIAS 0.659
