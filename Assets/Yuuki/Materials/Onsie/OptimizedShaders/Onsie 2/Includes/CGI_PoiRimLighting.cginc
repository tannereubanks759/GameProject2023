...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    #if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
        rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiMesh.uv[float(0)], float4(0,0,0,0)) * float4(0.2054128,0.06372052,0.06372052,1);
    #else
        rimColor = float4(0.2054128,0.06372052,0.06372052,1);
    #endif
    ...
    rim *= float4(0.2054128,0.06372052,0.06372052,1).a * rimColor.a * rimMask;
