Shader "Hidden/.poiyomi/• Poiyomi Toon •/Bra Fix-Bra Fix"
{
    Properties
    {
...
#define PROP_MATCAPREPLACE 0.224
...
#define PROP_SPECULARMETALLIC 0.371
#define PROP_SPECULARMAXBRIGHTNESS 0
#define PROP_SPECULARMETALLICMAPUV 0
#define PROP_SPECULARSMOOTHNESS 0.379
